...
<div class="mt-5">
  <div class="d-flex justify-content-center align-items-center">
    <form class="col-3 form-container">
      ...
      <div class="alert alert-success text-center mt-2" role="alert" id="reset_success"></div>
      <div class="alert alert-danger text-center mt-2" role="alert" id="reset_error"></div>
    </form>
  </div>
</div>
