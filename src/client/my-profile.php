...
<div id="profile_card">
  <div class="card col-md-8 m-auto px-5">
    <div class="row d-flex justify-content-center align-items-center">
      ...
      <div class="col-md-7">
        <h5 class="text-black fw-bold">Username:</h5>
        <h5>sample_user
        ...
        <h5 class='text-black fw-bold'>Email:</h5>
        <h5>sample@email.com <a class="text-dark" href="profile-edit.php">
            <i class="bi bi-pencil-square"></i>
          </a>
        </h5>
      </div>
    ...
    <?php for ($i = 0; $i < 5; $i++) {
      echo '<div class="row">
      <div class="col-md-10 offset-md-1">
        <h6 class="text-dark d-flex post_title_profile">Post Title
